...
-- Methods:
-- setText, setPos, setSize, setBackgroundColor, setBlinkColor, setActive, onClick
-- return button object so they can be chained eg:
-- myButton = button.create("My button").setSize(5,5).setBackgroundColor(colors.gray).onClick(function)
...
-- setBackgroundColor(color) - sets background color, parameter color - computercraft colors api
...
return {create = create, mergeTables = mergeTables, isButton = isButton, isTable = isTable, clearMon = clearMon, setMonitor = setMonitor, await = await}